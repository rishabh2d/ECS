...
double secondLoop(int mulligan, int j, double *prob2, int *hand, int *subdeck, int *totalcards) {// (SECOND LOOP) this loop runs the probability for the mulligans.
...
// Main Function only calls other functions and declares variables
int main(void) {
